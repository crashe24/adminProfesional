...
export class RegisterComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    }, // aqui va las validaciones de toda la forma
  ...
  registrarUsuario() {
    ...
    // console.log('Acepta las codiciones:', this.forma.value.condiciones);
    // console.log(this.forma.valid);
    // console.log(this.forma.value);
    const usuario = new Usuario(
      this.forma.value.nombre, this.forma.value.correo, this.forma.value.password
    );
